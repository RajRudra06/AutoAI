...
# Import Celery task
from worker_tasks.diagnosis import run_diagnosis  # Assuming you renamed the files
...
class MasterAgent:
    ...
    def enqueue_diagnosis_task(self, vehicle: dict, reasons: dict):
        ...
        try:
            ...
            print(f"[MASTER SHARD {self.shard_id}][TID:{thread_id}][ERROR] Failed to enqueue {vehicle_id}: {e}")
